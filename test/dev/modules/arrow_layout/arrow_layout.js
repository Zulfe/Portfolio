...
class ArrowLayout {
    constructor(container, UID) {
        ...
        console.log("EXCLUSIVE: " + this._EXCLUSIVE_TURN_ARROW_WIDTH);
    ...
    clickLeft(type) {
       ...
       $(_this).prepend("<img class='left exclusive arrow' style='height: " + (this._ARROW_HEIGHT * this._height_scale) + "px; margin-right: -" + this._EXCLUSIVE_ARROW_INWARD_MARGIN + "' src='assets/arrow_left.svg'>");
